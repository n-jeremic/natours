...
},{"axios":"../../node_modules/axios/index.js","./alerts.js":"alerts.js"}],"mapbox.js":[function(require,module,exports) {
"use strict";
...
if (settingsForm) {
  document.querySelector('.form-user-data').addEventListener('submit', function (event) {
    event.preventDefault();
...
if (passwordForm) {
  document.querySelector('.form-user-settings').addEventListener('submit',
  /*#__PURE__*/
  function () {
    var _ref = _asyncToGenerator(
    /*#__PURE__*/
